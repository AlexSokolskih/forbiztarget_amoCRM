...
class AmoTasks
{
    ...
    public function getTaskForIdDeal($dealId)
    {
        global $subdomain;

        $link = 'https://' . $subdomain . '.amocrm.ru/private/api/v2/json/tasks/list?type=lead&limit_rows=50&element_id=' . $dealId;
...
#Устанавливаем необходимые опции для сеанса cURL
    ...
    public function taskPinedDeal($deal_id)
    {
        global $subdomain;
